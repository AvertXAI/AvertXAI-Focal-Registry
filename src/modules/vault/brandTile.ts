 ...
 * out, and a missing file resolves null into the initials fallback. The lane dev host no longer
 * renders real icons after this change (its esbuild has no import.meta.glob) — stay-behind
 * tooling, accepted with the mount.
 */
const ICON_URLS = import.meta.glob("../../../modules/vault/assets/brand-icons/*", {
  eager: true,
  query: "?url",
  import: "default",
