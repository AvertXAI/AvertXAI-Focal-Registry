...
- **Check on boot and every six hours. Notify with a non-blocking toast. Download only on user consent. Install on quit.** Never pull a large download silently — the user may be on a slow or metered connection.
