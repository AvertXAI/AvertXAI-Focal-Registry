...
// Vault settings (mockup surface 8). The settings LIVE inside the encrypted vault file and the
// vault's lock gates every read and write of them — that part is unchanged. What changed 08-14-2026
// (Jason's ruling, recorded in CANON-UPDATES.md): the shell's Settings page now HOSTS this same
// surface through VaultSettings.tsx — two doors, one store, and the lock rules both. Carries the
// Lock section (the placeholder seam), the seed-data card Jason ruled on 08-06, and the storage
// facts.
    ...
    <>
      ...
      <div className="vault-card">
        <div className="vault-cardhead">
          <span className="vault-cardtitle">These settings live inside the Vault</span>
        </div>
        <div className="vault-hint">
          They are stored in the encrypted vault file and can only be read or changed while it is unlocked. The
          application's Settings page shows this same surface (Jason's ruling, 08-14-2026) — two doors, one store,
          and the master password rules them both.
        </div>
      </div>
